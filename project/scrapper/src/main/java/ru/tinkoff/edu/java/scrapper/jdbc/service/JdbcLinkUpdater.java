...
public class JdbcLinkUpdater implements LinkUpdater {
    ...
    private final JdbcChatToLinkService jdbcChatToLinkService;
    private final JdbcGithubLinkService jdbcGithubLinkService;
    private final JdbcStackoverflowLinkService jdbcStackoverflowLinkService;
